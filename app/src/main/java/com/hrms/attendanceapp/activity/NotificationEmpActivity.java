...
public class NotificationEmpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setStatusBarGradiant(NotificationEmpActivity.this);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_notification_emp);

        sh_Pref = getSharedPreferences("Login Credentials", Context.MODE_PRIVATE);
        toEdit = sh_Pref.edit();
        String strEmpcode = sh_Pref.getString("EMPCODE", "");
        String strId = sh_Pref.getString("USER_CODE", "");
        strcompnyimg = sh_Pref.getString("COM_LOGO", "");

        lin = (LinearLayout)findViewById(R.id.activity_noti_emp);




        imgBack = (ImageView)findViewById(R.id.imageview_noti_emp_back);
        imgBack.setOnClickListener(this);


        recyclerViewNoti = (RecyclerView) findViewById(R.id.recycler_view_noti_emp);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imageview_noti_emp_back:
                finish();
                break;
        }
    }
    ...
    private void callNotificationList(String userId) {
        ...
        customProgress.showProgress(NotificationEmpActivity.this, messag, false);
            ...
            if (jresData.has("status")) {
                ...
                if(satus.equalsIgnoreCase("true"))
                {
                    ...
                    for(int i = 0; i<jsonArray.length(); i++)
                    {
                        ...
                        String path = jsonobj_.getString("path");





                        notilist.add(new NotiList(id, Utils.parseDateToddMMyyyy(strdate), subject, strcontent, strReadfu, strcompnyimg));
                    ...
                    notiadapter.setOnItemClickListener(new NotiAdapter.onRecyclerViewItemClickListener() {
                        ...
                        public void onItemClickListener(View view, int position) {
                            ...
                            Intent intent = new Intent(NotificationEmpActivity.this, NotiDetailsEmpActivity.class);
                    ...
                    Toast.makeText(NotificationEmpActivity.this, error, Toast.LENGTH_LONG).show();
                }
            }
